...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"basicHellaCell" forIndexPath:indexPath];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(UITableViewCell *)cell {
    if ([segue.identifier isEqualToString:@"detailSegue"] &&
        [cell.reuseIdentifier isEqualToString:@"basicHellaCell"]) {
        FISHellaDetailViewController *detailVC = segue.destinationViewController;
        detailVC.cellDetailSource = cell;
    }
}
